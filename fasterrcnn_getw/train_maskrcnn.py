...
def main(args):
    ...
    # dataset_train, _ = get_dataset(args.dataset, "train",
    ...
    if args.distributed:
        ...
        # test_train_sampler = torch.utils.data.SequentialSampler(dataset_train)
    ...
    if args.model == 'resnet50':
        ...
        model = maskrcnn_resnet50_fpn(num_classes=num_classes, pretrained=args.pretrained)
