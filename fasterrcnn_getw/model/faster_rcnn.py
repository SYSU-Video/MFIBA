...
__all__ = [
    "FasterRCNN", "fasterrcnn_resnet50_fpn_ljl", "fasterrcnn_mobilenet_v3_large_320_fpn",
...
def fasterrcnn_resnet50_fpn_ljl(pretrained=False, progress=True,
                            num_classes=91, pretrained_backbone=True, trainable_backbone_layers=0, **kwargs):
    """
